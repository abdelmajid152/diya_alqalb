        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => AudioInfoDisplay(
                  title: 'سورة ${controller.currentName}',
                  subtitle: 'رقم السورة: ${controller.currentId}',
                ),
              ),
              const SizedBox(height: 40),
              ...
              Obx(
                () => Text(
                  '${controller.currentIndex.value + 1} / ${controller.suwarList.length}',
                  style: TextStyle(
                    fontSize: 14,
                    color: isDark
